...
let PLANNER_MODEL = "claude-sonnet-4-20250514";
let REVIEWER_MODEL = "claude-sonnet-4-20250514";
...
async function loadModelConfig() {
  try {
    ...
    if (config) {
      PLANNER_MODEL = config.plannerModel || "claude-sonnet-4-20250514";
      REVIEWER_MODEL = config.reviewerModel || "claude-sonnet-4-20250514";
