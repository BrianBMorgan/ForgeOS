const prompts = [
  {
    ...
    expectedFeatures: ["has_root_route", "no_banned_packages", "client_side_logic", "relative_fetch_urls", "listens_on_port_4000"],
  },
  {
    id: "calculator",
    category: "pure-frontend",
  ...
  },
  {
    ...
    expectedFeatures: ["has_root_route", "no_banned_packages", "relative_fetch_urls", "listens_on_port_4000", "no_dotenv"],
  },
  {
    id: "bookmarks-api",
    category: "api-only",
  ...
  },
  {
    ...
    expectedFeatures: ["has_root_route", "uses_neon_serverless", "no_banned_packages", "relative_fetch_urls", "listens_on_port_4000", "no_dotenv", "no_dynamic_sql"],
  },
  {
  ...
  },
  {
    ...
    expectedFeatures: ["has_root_route", "uses_neon_serverless", "no_banned_packages", "relative_fetch_urls", "listens_on_port_4000", "no_dotenv", "no_jwt_secret", "uses_jose_jwks"],
  },
  {
    id: "personal-journal",
    category: "auth-required",
    ...
    expectedFeatures: ["has_root_route", "uses_neon_serverless", "no_banned_packages", "relative_fetch_urls", "listens_on_port_4000", "no_dotenv", "no_jwt_secret", "uses_jose_jwks", "no_dynamic_sql"],
  },
  {
    id: "multi-file-blog",
    category: "multi-file",
  ...
  },
  {
    ...
    expectedFeatures: ["has_root_route", "no_banned_packages", "relative_fetch_urls", "listens_on_port_4000", "no_dotenv", "client_side_logic"],
  },
  {
    id: "no-deps-app",
    category: "edge-case",
    ...
    expectedFeatures: ["has_root_route", "listens_on_port_4000", "no_banned_packages", "no_dotenv"],
  },
  {
    id: "cors-api",
    category: "edge-case",
